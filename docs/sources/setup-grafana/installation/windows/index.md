...
Start Grafana by executing `grafana.exe server`, located in the `bin` directory, preferably from the command line. If you want to run Grafana as a Windows service, then download
