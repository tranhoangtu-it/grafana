...
export function createTypography(colors: ThemeColors, typographyInput: ThemeTypographyInput = {}): ThemeTypography {
  ...
  const variants = {
    h1: buildVariant(fontWeightBold, 24, 28, -0.5),
    h2: buildVariant(fontWeightBold, 20, 24, -0.25),
    h3: buildVariant(fontWeightMedium, 18, 22, 0),
    h4: buildVariant(fontWeightMedium, 16, 22, 0),
    h5: buildVariant(fontWeightMedium, 14, 20, 0),
