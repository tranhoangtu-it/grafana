  ...
  return [
    {
      name: 'red',
      shades: [
        { color: '#FFCEC2', name: 'super-light-red' },
        { color: '#FF9CB8', name: 'light-red' },
        { color: '#FF7383', name: 'red', primary: true },
        { color: '#E8506A', name: 'semi-dark-red' },
        { color: '#CC3A54', name: 'dark-red' },
      ],
    },
    {
      name: 'orange',
      shades: [
        { color: '#FFD4B0', name: 'super-light-orange', aliases: [] },
        { color: '#FFA67B', name: 'light-orange', aliases: [] },
        { color: '#FF8850', name: 'orange', aliases: [], primary: true },
        { color: '#FF6C2F', name: 'semi-dark-orange', aliases: [] },
        { color: '#E85A1A', name: 'dark-orange', aliases: [] },
      ],
    },
    {
      name: 'yellow',
      shades: [
        { color: '#FFF0A0', name: 'super-light-yellow', aliases: [] },
        { color: '#FFE866', name: 'light-yellow', aliases: [] },
        { color: '#F5D63A', name: 'yellow', aliases: [], primary: true },
        { color: '#E8C40E', name: 'semi-dark-yellow', aliases: [] },
        { color: '#D4AA00', name: 'dark-yellow', aliases: [] },
      ],
    },
    {
      name: 'green',
    ...
    },
    {
      name: 'blue',
      shades: [
        { color: '#CECEFF', name: 'super-light-blue', aliases: [] },
        { color: '#B0B0FF', name: 'light-blue', aliases: [] },
        { color: '#9C9CFF', name: 'blue', aliases: [], primary: true },
        { color: '#7878E0', name: 'semi-dark-blue', aliases: [] },
        { color: '#5858C4', name: 'dark-blue', aliases: [] },
      ],
    },
    {
      name: 'purple',
      shades: [
        { color: '#DBDAFF', name: 'super-light-purple', aliases: [] },
        { color: '#ADABFF', name: 'light-purple', aliases: [] },
        { color: '#837FFF', name: 'purple', aliases: [], primary: true },
        { color: '#6B67E0', name: 'semi-dark-purple', aliases: [] },
        { color: '#5450C4', name: 'dark-purple', aliases: [] },
      ],
    },
  ];
}
